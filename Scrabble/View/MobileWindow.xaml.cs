...
namespace Scrabble
{
    public partial class MobileWindow : Window, IView
    {
        ...
        public MobileWindow(int P, Game g)
        {
            ...
            this.Title = String.Format(Scrabble2018.Properties.Skin.MobileTitle);
            //MOBILE IS NOT WORKING ATM
        ...
        private void UpdatePlayerInfoLbl(int turn)
        {
            if (ThisPlayer == GameState.GSInstance.PlayerNow)
            {
                ...
                PlayerInfoLbl.Content = Scrabble2018.Properties.Skin.MobileYourTurn;
            }
            else
            {
            ...
            PlayerInfoLbl.Content = String.Format(Scrabble2018.Properties.Skin.MobilePlayerNow, turn + 1);
        }
        ...
        private void WriteToLabel(string str)
        {
            ...
            else
            {
                ...
                s += String.Format(Scrabble2018.Properties.Skin.MobilePlayerandScore, GameState.GSInstance.PlayerNow + 1);
        ...
        private void SwapButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (!SwapMode)
            {
                ...
                LoadBoardView();
                LoadRackView();
                SwapButton.Content = Scrabble2018.Properties.Skin.MobileFinishButton;
            ...
            else
            {
                ...
                SwapButton.Content = Scrabble2018.Properties.Skin.MobileSwapButton;
                PlayerNow = GameState.GSInstance.PlayerNow;
        ...
        public void OnStateChanged()
        {
            ...
            if (game.GameEnd())
            {
                ...
                WriteToLabel(String.Format(Scrabble2018.Properties.Skin.MobileWinner, game.gs.ListOfPlayers[0].Id + 1, game.gs.ListOfPlayers[0].Score));
                DisableEverthing();
                return;
            }
            PlayerNow = GameState.GSInstance.PlayerNow;
